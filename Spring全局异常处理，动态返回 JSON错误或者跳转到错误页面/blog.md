...
在 **Web** 应用开发中，使用 **Spring** 从 3.2 开始提供的注解 `@ControllerAdvice` 来全局地处理异常，达到解耦、封装、提炼优化代码，提升开发效率。这个注解有 5 个参数，实际上是 4 个有用的，一个是别名引用。
这 4 个有用的分别是：**basePackages**、**basePackageClasses**、**assignableTypes**、**annotations**。
